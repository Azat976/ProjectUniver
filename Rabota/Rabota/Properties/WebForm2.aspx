<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Rabota.Properties.WebForm2" %>
...
<body>
    ...
    <form id="form2" runat="server" submitdisabledcontrols="False">
        ...
        <div style = "width: 100%; height: 150px">
            <asp:Label ID="Label12" runat="server" width="56px" Height="25px" Text="id"></asp:Label>
                <asp:TextBox ID="TextBox3" runat="server" Width="56px" Height="25px"></asp:TextBox></br>
                <asp:Label ID="Label2" runat="server"  width="56px" Height="25px" Text="Brandid"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" Width="56px" Height="25px" OnTextChanged="TextBox1_TextChanged1"></asp:TextBox></br>
                <asp:Label ID="Label3" runat="server"  width="56px" Height="25px" Text="Name"></asp:Label>
                <asp:TextBox ID="TextBox2" runat="server" Width="56px" Height="25px"></asp:TextBox><br />
                <asp:Label ID="Label5" runat="server"  width="56px" Height="25px" Text="Active"></asp:Label>
                <asp:TextBox ID="TextBox4" runat="server" Width="56px" Height="25px" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
            </div>
         <div>
             <asp:Label ID="Label4" runat="server" height="25px" width="50px" Text="Models"></asp:Label>
             </div>
